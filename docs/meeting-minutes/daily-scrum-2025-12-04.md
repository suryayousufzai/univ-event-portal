# 🧑‍💻 Daily Scrum Meeting – Sprint 5, Day 2
...
* Recapped what we're building:
  * **US-003 Profile Management** — in progress, should finish today
  * **US-005 Advanced Search** — started, about 30% done
  * **US-010 Cancel Registration** — will start tomorrow
  * **NFR-005 Browser Testing** — Gita testing on Chrome
